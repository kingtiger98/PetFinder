...
class TapBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        configureTabBarItem(title: "오늘공고", image: "checkerboard.rectangle", nav: thirdNavigationController)
    ...
    func configureTabBarItem(title: String, image: String, nav: UINavigationController){
        ...
        // tabBarItem.setTitleTextAttributes([.foregroundColor: UIColor(named: "BackgroundColor")!], for: .selected)
        ...
        tabBarItem.setTitleTextAttributes([.font: customFont2!], for: .normal)
        
        // 네비게이션 바 타이틀에 폰트를 적용합니다.
        nav.navigationBar.titleTextAttributes = [.font: customFont!, .foregroundColor: UIColor(named: "Title")!]
